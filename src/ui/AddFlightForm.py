...
class AddFlightForm(ctk.CTkToplevel):
    def __init__(self, submit_command):
        ...
        self.fields = dict()
        self.fields["airline"] = labeledComboBox(self, width=230, text="Airline", values=config.data["flight_info"]["flight_names"], row=0, column=0, padx=30, pady=10)
        self.fields["place_of_departure"] = labeledComboBox(self, width=230, text="Place Of Departure", values=config.data["flight_info"]["states"], row=1, column=0, padx=30, pady=10)
        self.fields["destination"] = labeledComboBox(self, width=230, text="Destination", values=config.data["flight_info"]["states"], row=2, column=0, padx=30, pady=10)
        self.fields["class"] = labeledComboBox(self, width=230, text="Class", values=config.data["flight_info"]["flight_classes"], row=3, column=0, padx=30, pady=10)
        
        self.flight_departure_time_frame = ctk.CTkFrame(self, fg_color="transparent")
        self.flight_departure_time_frame.grid(row=4, column=0, padx=30, pady=10)
        
        self.flight_departure_time_label = ctk.CTkLabel(self.flight_departure_time_frame, text="Departure Time")
        self.flight_departure_time_label.grid(row=0, column=0, padx=10, sticky='w')
